...
/**
 * This file keeps track of upgrades to the testmodule module
 *
...
/**
 * Execute testmodule upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_testmodule_upgrade($oldversion) {
    global $DB;
     ...
     * for demonstrative purposes and to show how the testmodule
     * iself has been upgraded.
     *
     * For each upgrade block, the file testmodule/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to testmodule.
        ...
        // Define field intro to be added to testmodule.
        $table = new xmldb_table('testmodule');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'testmodule');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define index course (not unique) to be added to testmodule.
        $table = new xmldb_table('testmodule');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'testmodule');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'testmodule');
    }
